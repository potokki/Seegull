...
namespace PVPAssister.Yingxiong
{
    public class YingxiongInfo
    {
        ...
        public const string OutputTitle = "Yingxiong,4-类型,4-B,4-G,4-R,5-类型,5-B,5-G,5-R,4-类型,4-B,4-G,4-R,5-类型,5-B,5-G,5-R,D4-B,D4-G,D4-R,D5-B,D5-G,D5-R";

        public YingxiongInfo()
        {
            int max = MingwenOverall.MaxMingwenLevel + 1;
        ...
        {
            string str =
                $"{Name},{MingwensBySystem[4]},{MingwensBySystem[5]},{Mingwens[4]},{Mingwens[5]},{Mingwens[4].ToDetailedString()},{Mingwens[5].ToDetailedString()}";
